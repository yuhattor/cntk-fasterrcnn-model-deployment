...
__C.CNTK.DATASET = "FromUrl" # "Grocery" or "Pascal"
...
# Data sets
#
if __C.CNTK.DATASET == "Baseball2":
    __C.CNTK.MAP_FILE_PATH = "../../DataSets/Baseball2"
    ...
    __C.CNTK.NUM_TRAIN_IMAGES = 173 
    __C.CNTK.NUM_TEST_IMAGES = 1
    __C.CNTK.PROPOSAL_LAYER_PARAMS = "'feat_stride': 16\n'scales':\n - 4 \n - 8 \n - 12"

if __C.CNTK.DATASET == "FromUrl":
    __C.CNTK.MAP_FILE_PATH = "./"
    __C.CNTK.CLASS_MAP_FILE = "class_map.txt"
    __C.CNTK.NUM_TRAIN_IMAGES = 173 
    __C.CNTK.NUM_TEST_IMAGES = 1
    __C.CNTK.PROPOSAL_LAYER_PARAMS = "'feat_stride': 16\n'scales':\n - 4 \n - 8 \n - 12"
